<?php
	...
	$resPets = mysqli_query($conn, "SELECT * FROM `animal` WHERE `animal_age` BETWEEN 1 AND 7");
?>
...
<head>
	...
	<link rel="stylesheet" href="style.css">
			<img src="images/coverr.jpg" alt="animal"><hr>
